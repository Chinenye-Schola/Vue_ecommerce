<template>
  <div class="wrapper box-layout">
    ...
    <header>
      ...
      <!-- header middle start -->
      <div
        class="header-middle-area header-middle-style-2 pt-20 pb-20 pb-md-0 pb-sm-0"
      >
        <div class="container">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <ul class="dropdown">
                          <li>
                            <a href="#"
                              >shop grid layout <i class="fa fa-angle-right"></i
                            ></a>
                            <ul class="dropdown">
                              <li>
                          ...
                          <li>
                            <a href="#"
                              >shop list layout <i class="fa fa-angle-right"></i
                            ></a>
                            <ul class="dropdown">
                              <li>
                          ...
                          <li>
                            <a href="#"
                              >products details <i class="fa fa-angle-right"></i
                            ></a>
                            <ul class="dropdown">
                              <li>
